...
jsPsych.plugins['custom-likert'] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
        ...
        html += ".jspsych-survey-likert-statement { display:block; font-size: 16px; padding-top: 40px; margin-bottom:10px; }" +
            ...
            ".jspsych-survey-likert-opts:before { content: ''; position:relative; top:11px; left:9%; display:block; background-color:#efefef; height:4px; width:82%; }" +
